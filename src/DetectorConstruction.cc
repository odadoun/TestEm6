...
G4VPhysicalVolume* DetectorConstruction::ConstructVolumes()
{
  ...
  G4Box* sWorld = new G4Box("World",20.*fBoxSize/2,20.*fBoxSize/2,20*fBoxSize/2);
...
{
  G4cout << " ############################################### " << G4endl;	
  G4cout << " # The Box is " << G4BestUnit(fBoxSize,"Length") << " of " << fMaterial->GetName() << " ###" << G4endl;
  G4cout << " ############################################### " << G4endl;	
}
